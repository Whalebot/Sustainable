...
public class BoatFoodCity : MonoBehaviour
{
    public bool boatIsSailing;
    public bool stoppingBoat;
    public bool sailing;
    ...
    IEnumerator SailCoroutine()
    {
        ...
        while (boatIsSailing == true)
        {
            ...
            else if (boatIsSailing == true)
            {
                ...
                else if (turn == 30) //THIS IS FOR IMMEDIATE TURN 180.
                {
